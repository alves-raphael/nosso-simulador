...
import { calcular } from './price-calculator.js';
...
function init() {
  ...
  document.getElementById('form-price').addEventListener('submit', (e) => {
    e.preventDefault();
  ...
  document.getElementById('form-price').addEventListener('reset', () => {
